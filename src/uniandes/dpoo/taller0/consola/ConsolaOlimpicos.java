...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar la nacionalidad de un atleta por nombre");
	...
	{
		System.out.println("\n" + "Nacionalidad de un atleta por nombre" + "\n");

		String nombre = input("Ingrese el nombre de el atleta");
		String pais=calculadora.AtletaporNombre(nombre);
